...
class BowlingGameTest extends TestCase
{
    ...
    public function test_it_scores_all_ones()
    {
        $game = new BowlingGame();
    ...
    public function test_it_awards_a_two_roll_bonus_for_every_strike()
    {
        $game = new BowlingGame();
    ...
    public function test_a_spare_on_the_final_frame_grants_one_extra_ball()
    {
        $game = new BowlingGame();
    ...
    public function test_a_strike_on_the_final_frame_grants_two_extra_ball()
    {
        $game = new BowlingGame();
    ...
    public function test_it_score_a_perfect_game()
    {
        $game = new BowlingGame();
